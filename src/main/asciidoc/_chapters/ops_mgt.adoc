...
----
 $ ./bin/hbase org.apache.hadoop.hbase.regionserver.wal.DefaultFSWAL --dump hdfs://example.org:8020/hbase/WALs/example.org,60020,1283516293161/10.10.21.10%3A60020.1283973724012
----
...
----
 $ ./bin/hbase org.apache.hadoop.hbase.regionserver.wal.DefaultFSWAL --split hdfs://example.org:8020/hbase/WALs/example.org,60020,1283516293161/
----
